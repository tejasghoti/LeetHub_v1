...
COUNT(CASE WHEN event_type = 'downgrade' THEN 1 ELSE NULL END) OVER(PARTITION BY user_id) is_hv_downgrade,
MAX(CASE WHEN event_type = 'cancel' THEN event_date ELSE '1900-01-01' END) OVER(PARTITION BY user_id) max_cancel_event_date
